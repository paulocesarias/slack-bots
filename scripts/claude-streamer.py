...
Usage:
    python3 claude-streamer.py <slack_token> <channel> <thread_ts> <session_id> <base64_message>
...
def main():
    if len(sys.argv) != 6:
        print("Usage: python3 claude-streamer.py <slack_token> <channel> <thread_ts> <session_id> <base64_message>")
